...
def getFromConfig():
    ...
    subject_file_path = os.path.join(desktop_path, 'INFO_LOGS', 'settings', 'SUBJECT.txt')
    message_file_path = os.path.join(desktop_path, 'INFO_LOGS', 'settings', 'MESSAGE.txt')
    receivers_file_path = os.path.join(desktop_path, 'INFO_LOGS', 'logs', 'RECEIVER_EMAILS.txt')
    ...
    sender_txt_path = os.path.join(desktop_path, 'INFO_LOGS', 'config', 'SENDER.txt')
    try:
